...
export default {
  ...
  mounted () {
    ...
    if (localStorage.getItem(localStorageName + '/username')) {
      const username = (localStorage.getItem(localStorageName + '/username'))
      this.$store.dispatch('passUsername', username)
    }
    if (localStorage.getItem(localStorageName + '/diversitySynchronizeLanguage')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversitySynchronizeLanguage') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyLoadingMode')) {
      const loading = LoadingModes.filter(k => k.key === localStorage.getItem(localStorageName + '/diversityNaviKeyLoadingMode'))
    ...
    if (localStorage.getItem(localStorageName + '/diversityDefaultDatasourceID')) {
      const id = localStorage.getItem(localStorageName + '/diversityDefaultDatasourceID')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyColorTheme')) {
      const navColorTheme = ColorThemes.filter(k => k.key === localStorage.getItem(localStorageName + '/diversityNaviKeyColorTheme'))
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyCategoricalToleranceMode')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityNaviKeyCategoricalToleranceMode') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyPositiveCategoricalToleranceMode')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityNaviKeyPositiveCategoricalToleranceMode') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyNumFilterIncludeExtremeValues')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityNaviKeyNumFilterIncludeExtremeValues') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNoDatasourceDialog')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityNoDatasourceDialog') === 'true')
      this.$store.dispatch('passNoDatasourceDialog', isSet)
    }
    if (localStorage.getItem(localStorageName + '/diverstiyUseRestrictFilter')) {
      const isSet = (localStorage.getItem(localStorageName + '/diverstiyUseRestrictFilter') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/diversityNaviKeyLanguage')) {
      const lang = AppLanguages.filter(k => k.key === localStorage.getItem(localStorageName + '/diversityNaviKeyLanguage'))
      ...
      if (this.$i18n.locale) {
        const lang = AppLanguages.filter(k => k.key === this.$i18n.locale)
        if (lang && lang.length > 0) {
          if (this.$i18n.locale === 'ar' || this.$i18n.locale === 'he') {
            this.$vuetify.rtl = true
          } else {
    ...
    if (localStorage.getItem(localStorageName + '/diversitySortSettings')) {
      const sortSettings = localStorage.getItem(localStorageName + '/diversitySortSettings')
    ...
    if (localStorage.getItem(localStorageName + '/diversityUseTaxonScopeInfo')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityUseTaxonScopeInfo') === 'true')
      this.$store.dispatch('passUseTaxonScope', isSet)
    }
    if (localStorage.getItem(localStorageName + '/diversityUseTaxonSinAuthor')) {
      const isSet = (localStorage.getItem(localStorageName + '/diversityUseTaxonSinAuthor') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/showDescriptorStateImagesIfAvailable')) {
      const isSet = (localStorage.getItem(localStorageName + '/showDescriptorStateImagesIfAvailable') === 'true')
    ...
    if (localStorage.getItem(localStorageName + '/showItemImagesIfAvailable')) {
      const isSet = (localStorage.getItem(localStorageName + '/showItemImagesIfAvailable') === 'true')
